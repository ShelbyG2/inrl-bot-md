...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || 'inrl~eff39oCnV864576068f9c10408d481354add', //your ssid to run bot
    HEROKU: {
    ...
    BOT_INFO : process.env.BOT_INFO || "SHELBY-MD;INRL;https://telegra.ph/bot-04-08-15",
    ...
    AUDIO_DATA : process.env.AUDIO_DATA || "SHELBY-MD;INRL;https://telegra.ph/bot-04-08-15",
